...
// If Alert, AlertTitle, and AlertDescription should also be part of this file, define them here:
...
export { Card, CardHeader, CardTitle, CardContent, CardFooter, Alert, AlertTitle, AlertDescription };